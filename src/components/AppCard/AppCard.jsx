...
const AppCard = ({ app }) => {
  ...
  return (
    <div className="p-4 shadow-[0_10px_20px_-12px_rgba(0,0,0,0.1)] rounded-lg bg-white transition-transform duration-300 hover:-translate-y-2">
      <figure className=" flex justify-center items-center ">
        <img className="h-48 w-full object-contain" src={image} alt={title} />
      </figure>
      <h3 className="text-[#001931] text-xl font-medium my-4">{title}</h3>
